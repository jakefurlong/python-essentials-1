...
# from the previous lab (3.1.2.10) and create a better, upgraded (pretty) vowel eater! 
...
# Use concatenation operation to ask Python to combine selected letters into a longer string 
# during subsequent loop turns, and assign it to the word_without_vowels variable.
