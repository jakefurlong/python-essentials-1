...
# Of course, it's an extremely complex task to use a computer in order to prove the hypothesis 
# for any natural number (it may even require artificial intelligence), 
# but you can use Python to check some individual numbers. 
# Maybe you'll even find the one which would disprove the hypothesis.


# Write a program which reads one natural number and executes the above steps 
# as long as c0 remains different from 1. We also want you to count the steps needed to achieve the goal. 
